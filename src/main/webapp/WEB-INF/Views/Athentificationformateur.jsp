...
<body>
    ...
    <div class="bg-img">
      <div class="content">
        ...
        <form action=formateurlogin method="Post" modelAttribute="athentificationformateur">
          <div class="field">
            <span class="fa fa-user"></span>
            <input type="text" required placeholder="Email or Phone" name="nom">
          </div>
...
<button type="submit">login</button>
        ...
        <div class="signup">Don't have account?
          <a href="/registreformateur">Signup Now</a>
